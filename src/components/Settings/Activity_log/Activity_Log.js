...
import style from "./activity_log_style.module.css"
import img_user_account from "../../../static/img/img_user_account.png"
import Activity_Log_content from './Activity_Log_content';
                    ...
                    <div className={style.top_container}>
                        <div className={style.top_content}>
                            <div className={style.left_title}>
                                <p><a className={style.top_main_title}>Cài đặt hệ thống ></a> Nhật ký hoạt động</p>
                            </div>
