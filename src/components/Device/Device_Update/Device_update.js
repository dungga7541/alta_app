...
import style from "./device_update_style.module.css"
import img_user_account from "../../../static/img/img_user_account.png"
import Device_update_content from '../Device_Update/Device_update_content';
                    ...
                    <div className={style.top_container}>
                        <div className={style.top_content}>
                            <div className={style.left_title}>
                                <p><a className={style.top_main_title}>Thiết bị > Danh sách thiết bị > </a> Cập nhập thiết bị</p>
                            </div>
