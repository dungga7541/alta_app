...
import style from "./level_management_add_style.module.css"
import img_user_account from "../../../static/img/img_user_account.png"
import Level_management_add_content from '../Level_management_Add/Level_management_add_content';
                    ...
                    <div className={style.top_container}>
                        <div className={style.top_content}>
                            <div className={style.left_title}>
                                <p><a className={style.top_main_title}>Thiết bị > Danh sách cấp số > </a> Cấp số mới</p>
                            </div>
