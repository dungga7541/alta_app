...
import style from "./level_management_style.module.css"
import img_user_account from "../../static/img/img_user_account.png"
import Level_management_content from './Level_management_content';
                    ...
                    <div className={style.top_container}>
                        <div className={style.top_content}>
                            <div className={style.left_title}>
                                <p><a className={style.top_main_title}>Cấp số  > </a> Danh sách cấp số</p>
                            </div>
